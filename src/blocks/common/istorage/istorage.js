  ...
  (function () {
    ...
    function _sendMessage(data) {
      _isIframeLoaded()
        ...
        : _sendMessageOnIframeLoad(function () {
            _postMessageOnCurrentWindow(data);
          }, data.payload.key);
    }
    ...
    function _sendMessageOnIframeLoad(sendMessageFn) {
      ...
      if (!_iframeEl) {
        ...
        _iframeEl.onload = function () {
          ...
          _sendMessageFns.forEach(function (fun) {
            fun();
          });
        };
      }
    ...
    function _processPostMessage(sourceWindow, data) {
      ...
      switch (data.type) {
        ...
        case ACTION_TYPES.getResponse:
          _callRequestCallback(payload.requestID, payload.value, sourceWindow);
          break;
    ...
    function _init() {
      ...
      try {
        ...
        console.warn(
          'Cross domain storage blocked, because "Block third-party cookies" is enable'
        );
